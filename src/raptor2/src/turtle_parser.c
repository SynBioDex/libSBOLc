...
{
       0,   186,   186,   189,   196,   200,   199,   231,   230,   257,
...
/* Line 1000 of yacc.c  */
#line 1340 "turtle_parser.c"
	break;
      case 35: /* "graphName" */

/* Line 1000 of yacc.c  */
#line 174 "./turtle_parser.y"
	{
...
#line 200 "./turtle_parser.y"
    ...
    if(!turtle_parser->trig)
      ...
      turtle_parser->graph_name = (yyvsp[(1) - (3)].identifier); /* becomes owner of $1 */
...
#line 285 "./turtle_parser.y"
  ...
  if((yyvsp[(1) - (2)].identifier))
    raptor_term_print_as_ntriples(stdout, (yyvsp[(1) - (2)].identifier));
  else
    fputs("NULL", stdout);
...
#line 330 "./turtle_parser.y"
  ...
  if((yyvsp[(3) - (3)].identifier)) {
    printf(" object=\n");
    raptor_term_print_as_ntriples(stdout, (yyvsp[(3) - (3)].identifier));
    printf("\n");
  } else  
...
#line 370 "./turtle_parser.y"
  ...
  if((yyvsp[(1) - (1)].identifier)) {
    printf(" object=\n");
    raptor_term_print_as_ntriples(stdout, (yyvsp[(1) - (1)].identifier));
    printf("\n");
  } else  
    printf(" and empty object\n");
#endif
...
#line 414 "./turtle_parser.y"
  ...
  if((yyvsp[(2) - (2)].identifier)) {
    printf(" object=\n");
    raptor_term_print_as_ntriples(stdout, (yyvsp[(2) - (2)].identifier));
    printf("\n");
  } else  
    printf(" and empty object\n");
...
#line 521 "./turtle_parser.y"
  ...
  raptor_term_print_as_ntriples(stdout, (yyvsp[(3) - (4)].identifier));
  printf("\n objectList=");
...
#line 726 "./turtle_parser.y"
  ...
  RAPTOR_FREE(cstring, (yyvsp[(1) - (3)].string));
  RAPTOR_FREE(cstring, (yyvsp[(3) - (3)].string));
  if(!(yyval.identifier))
    YYERROR;
}
    break;
...
#if RAPTOR_DEBUG > 1  
    printf("resource\n propertyList=");
    raptor_term_print_as_ntriples(stdout, (yyval.identifier));
    printf("\n");
#endif
  } else {
    /* non-empty property list, handle it  */
